...
(use-package hel
  :vc (:url "https://github.com/helheim-emacs/hel.git" :rev "main")
...
(elpaca '(hel :host github :repo "helheim-emacs/hel")
...
(straight-use-package '(hel :host github :repo "helheim-emacs/hel"))
(setopt inhibit-startup-screen t)
(hel-mode)
#+end_src
...
- [[https://github.com/sponsors/anuvyklack][GitHub Sponsors]]
- [[https://www.paypal.me/anuvyklack][PayPal]]
- Bitcoin and USDT wallets — coming soon.
